...
const Home: NextPage = () => {
  ...
  return (
    <Layout
      title={`${fiexdSentence.date}H-NEXTでFALENO作品が大量配信中｜人気作品をまとめました`}
    ...
    >
      <h1 className="text-xl sm:text-2xl text-gray-600">
        {`${fiexdSentence.date}H-NEXTでFALENO作品が大量配信中｜人気作品をまとめました`}
      </h1>
      ...
      <h2 className="text-3xl">H-NEXTで見れるFALENO作品ランキングTOP100！</h2>
